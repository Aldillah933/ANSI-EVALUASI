...
<div class="menu-section">
    ...
    <div class="menu-cards">
        <div class="menu-card">
            ...
            <a href="<?= base_url('/akreditasi/ringkasan') ?>">Lihat Selengkapnya</a>
        </div>
        <div class="menu-card">
            <h3>Rekap Nilai</h3>
            <a href="<?= base_url('/grafik/indikator') ?>">Lihat Grafik</a>
        </div>
        <div class="menu-card">
            <h3>Efaluasi Dosen Oleh Mahasiswa</h3>
            <a href="<?= base_url('/pengingat/bukti') ?>">Cek Sekarang</a>
        </div>
    </div>
</div>
