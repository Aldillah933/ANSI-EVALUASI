    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="<?= base_url('/evaluasi_dosen/index') ?>">Evaluasi Kinerja Dosen oleh Mahasiswa</a></li>
            <li><a class="dropdown-item" href="<?= base_url('/evaluasi_matkul/index') ?>">Evaluasi Mata Kuliah</a></li>
